         ...
         <div class="col-md-12">
            <div class="card card-primary">
               <div class="card-header">
                  <h3 class="card-title">Create tool arragement</h3>
               </div>
               <div class="card-body">
                  <form action="{{ route('arragement.store') }}" method="post">
                  @csrf
                     ...
                     <label for="">Rak</label>
                     <input type="number" name="rak" class="form-control @error('rak') is-invalid @enderror">
                     @error('rak')
                        <div class="invalid-feedback">
                           {{ $message }}
                        </div>
                     ...
                     <input type="number" name="goodCondition" class="form-control @error('goodCondition') is-invalid @enderror" value="0">
                     @error('goodCondition')
                        <div class="invalid-feedback">
                           {{ $message }}
                        </div>
                     ...
                     <input type="number" name="badCondition" class="form-control @error('badCondition') is-invalid @enderror" value="0">
                     @error('badCondition')
                        <div class="invalid-feedback">
                           {{ $message }}
                        </div>
